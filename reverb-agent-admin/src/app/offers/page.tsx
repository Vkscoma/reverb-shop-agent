...
const styles = stylex.create({
  ...
  title: { color: "var(--foreground)", fontSize: 36, letterSpacing: "-0.04em", margin: "8px 0 10px" },
  intro: { color: "var(--muted)", margin: "0 0 32px" },
  card: { backgroundColor: "var(--surface)", borderColor: "var(--border)", borderRadius: 12, borderStyle: "solid", borderWidth: 1, boxShadow: "0 8px 24px rgba(0,0,0,0.12)", padding: 24 },

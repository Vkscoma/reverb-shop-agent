...
const styles = stylex.create({
  form: { display: "grid", gap: 16, gridTemplateColumns: "repeat(4, minmax(0, 1fr))", "@media (max-width: 850px)": { gridTemplateColumns: "repeat(2, minmax(0, 1fr))" }, "@media (max-width: 560px)": { gridTemplateColumns: "1fr" } },
